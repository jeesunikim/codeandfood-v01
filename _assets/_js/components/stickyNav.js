...
export default class StickyNav {
    constructor(el) {
        ...
        this.mobileScrolledNavMenu = document.querySelector(
            ".hamburger-menu.is--scrolled"
        );
        this.mobile = el.querySelector(".mobile-nav");
        this.mobileMenu = this.mobile.querySelector(".hamburger-menu");

        this.defaultNavHeight = el.clientHeight;
        ...
        this.mobileScrolledNavMenu.addEventListener(
            "click",
    ...
    onScroll() {
        ...
        currentMaxScroll = this.isDesktop
            ? MAX_SCROLL_TOP_DESKTOP
            : MAX_SCROLL_TOP_MOBILE;
        newNavHeight = this.defaultNavHeight - scrollTop;
        newBoxTitleHeight = this.isDesktop
            ? this.defaultBoxTitleHeight - scrollTop / 3
            : this.mobile.clientHeight;
        ...
        this.el.style.lineHeight = newNavHeight + "px";
